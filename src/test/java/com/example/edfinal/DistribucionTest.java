...
class DistribucionTest {
    ...
    void cuentaElIris() {
        Map<String, Integer> c = HelloController.contarPorEtiqueta(GestorTxt.getIrisDataset());
    ...
    void cuentaElEjemplo() throws IOException {
        Map<String, Integer> c = HelloController.contarPorEtiqueta(
    ...
    void sinEtiquetas() throws IOException {
        ...
        try {
            ...
            assertTrue(HelloController.contarPorEtiqueta(d).isEmpty());
        } finally {
